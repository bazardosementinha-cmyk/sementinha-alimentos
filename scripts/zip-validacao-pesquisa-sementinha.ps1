...
$ZipName = "sementinha-alimentos-validacao-pesquisa.zip"
$ZipPath = Join-Path $OutputDir $ZipName
$TempDir = Join-Path $OutputDir "zip-validacao-temp"
...
# Remove pastas pesadas ou desnecessárias
$excludeDirs = @(
  "node_modules",
  ".next",
  ".git",
...
foreach ($dir in $excludeDirs) {
  ...
  foreach ($path in $paths) {
    ...
    Write-Host "Removido: $($path.FullName)"
  }
}

# Remove arquivos .env reais por segurança
